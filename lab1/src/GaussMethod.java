...
public class GaussMethod {
    ...
    public static double[][] calculateTriangleMatrix(double[][] matrix) {
        ...
        for(int i = 0; i < n; i++) {
            ...
            if(point != i) System.out.println(("Замена строк №" + (point + 1) + " and № " + (i+1)));
            else System.out.println("Замена не требуется");
            ...
            System.out.println("После преобразования матрицы №" + (i+1));
            Printer.printMatrix(matrix);
        }
        return matrix;
    }
